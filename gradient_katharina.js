...
function init() {
  ...
  sceneObjects.push(createGradientMeshToPosition(0x068282, 0x00FF00, new THREE.BoxGeometry(10, 10, 10), 0));
  ...
  document.getElementById('gradient_katharina').appendChild(renderer.domElement);
